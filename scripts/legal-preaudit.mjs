...
const requiredFiles=[
  ...
  'core/legal-gcp-bound-transport.mjs','core/legal-gcp-runtime-identity.mjs','core/legal-vertex-proposal.mjs','core/legal-gcp-runtime-pipeline.mjs',
...
const regressionNames=[
  ...
  'production transport pins native dependencies and test dependency substitution is production-blocked',
  ...
  'GCE runtime identity comes only from module-pinned metadata fetch and rejects runtime global fetch substitution',
  'missing accessible-services or malformed effective policy collections fail closed',
  ...
  'network collector derives workload lookup from authenticated runtime metadata',
  ...
  'network collector fetches effective global regional and exact runtime workload NIC firewall views',
  ...
  'kill switch change after token acquisition is rechecked immediately before send',
  'stalled token acquisition cannot send after network attestation expiry',
...
const report={
  schema:'trustready-legal-preaudit-v7',generated_at:now.toISOString(),
