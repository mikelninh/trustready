...
const regressionNames=[
  ...
  'network collector fetches effective global regional and exact workload NIC firewall views',
...
const report={
  schema:'trustready-legal-preaudit-v5',generated_at:now.toISOString(),
