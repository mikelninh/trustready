...
const regressionNames=[
  ...
  'GCE runtime identity comes only from local metadata and rejects custom production fetch injection',
...
const report={
  schema:'trustready-legal-preaudit-v6',generated_at:now.toISOString(),
