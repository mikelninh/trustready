...
export async function collectPublicGitHubSnapshot(inputUrl, { fetchImpl = globalThis.fetch, observedAt = new Date() } = {}) {
  ...
  return {
    ...
    collection: {
      ...
      boundary: 'Only public repository evidence is collected. Absence from GitHub is not proof that an organisational, deployment or private control does not exist elsewhere.',
    },
  }
}
