...
import { createRestrictedGoogleApiTransportForTest } from './legal-gcp-bound-transport.mjs'
...
function transport({ signer=networkSigner, resolve4=async()=>['199.36.153.4'], tls_connect=tlsFactory(), https_request=httpsFactory() }={}) { return createRestrictedGoogleApiTransportForTest({signer,resolve4,tls_connect,https_request}) }
